...
public interface IBaseDao<T> {
    ...
    //分页查询
    public Page<T> findPage(final Integer currentPage, final Integer pageSize, final String queryHql, final String countHql, final Object[] values)
            throws HibernateException,SQLException;
    public Page<T> findPage(final Integer currentPage, final Integer pageSize, final String queryHql, final String countHql)
            throws HibernateException,SQLException;
