 ...
 * @Author: 王金海
 * @Description:
 * @Date: Created by Administrator on 2017/9/28.
 * @Modified By:
 */
public class ChineseToSpell {
    ...
    public static void main(String[] args) {
        List<ArsfcGeoCityBean> beans = new ArrayList<ArsfcGeoCityBean>();

        for (ArsfcGeoCityBean bean : beans) {
            String s = bean.getName().substring(0,1);
            out.println(s);
            String s1 = ChineseToSpell.getAllFirstSpell(s);
            bean.setLetter(s1);
        }
        Collections.sort(beans, new Comparator<ArsfcGeoCityBean>() {
            Collator collator = Collator.getInstance(java.util.Locale.CHINA);
            public int compare(ArsfcGeoCityBean arg0, ArsfcGeoCityBean arg1) {
                String name0 = arg0.getLetter();
                String name1  = arg1.getLetter();
