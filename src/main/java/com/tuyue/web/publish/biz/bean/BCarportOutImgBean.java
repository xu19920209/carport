 ...
 * @Modified By:
 */
public class BCarportOutImgBean {
    ...
    public BCarportOutImgBean() {
    }

    @Override
    public String toString() {
        return "BCarportOutImgBean{" + "bid=" + bid + ", aid=" + aid + ", carportType=" + carportType + ", floor='" + floor + '\'' + ", carportNo='" + carportNo + '\'' + ", maxSize=" + maxSize + ", carSize='" + carSize + '\'' + ", rental=" + rental + ", housesName='" + housesName + '\'' + ", province='" + province + '\'' + ", city='" + city + '\'' + ", region='" + region + '\'' + ", businessCircles='" + businessCircles + '\'' + ", housesAdress='" + housesAdress + '\'' + ", title='" + title + '\'' + ", details='" + details + '\'' + ", mainImg='" + mainImg + '\'' + ", linkman='" + linkman + '\'' + ", pjone='" + pjone + '\'' + ", isPrivary=" + isPrivary + ", isSale=" + isSale + ", salePrice=" + salePrice + ", saleMoney=" + saleMoney + ", issueTime=" + issueTime + ", enterpriseType=" + enterpriseType + ", rentType=" + rentType + ", isPutaway=" + isPutaway + ", pointNum=" + pointNum + ", isLowerMoney=" + isLowerMoney + ", lowerMoney=" + lowerMoney + ", cCarportImgs=" + cCarportImgs + '}';
    }

    public BCarportOutImgBean(int bid, Integer aid, Integer carportType, String floor, String carportNo, Double maxSize, String carSize, Double rental, String housesName, String province, String city, String region, String businessCircles, String housesAdress, String title, String details, String mainImg, String linkman, String pjone, Integer isPrivary, Integer isSale, Double salePrice, Double saleMoney, Timestamp issueTime, Integer enterpriseType, Integer rentType, Integer isPutaway, Long pointNum, Integer isLowerMoney, Double lowerMoney, List<CCarportImg> cCarportImgs) {
        this.bid = bid;
        this.aid = aid;
        this.carportType = carportType;
        this.floor = floor;
